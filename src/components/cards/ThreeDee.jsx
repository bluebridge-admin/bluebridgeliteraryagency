...
const StyledDiv = styled.div`
  ...
  &:hover .cardContainer .bottom .social-buttons-container .social-button {
    transform: translate3d(0, 0, 50px);
    box-shadow: rgba(5, 71, 17, 0.2) -5px 20px 10px 0px;
  }

  &:hover .cardContainer .logo .circle2 {
    transform: translate3d(0, 0, 60px);
  }

  &:hover .cardContainer .logo .circle3 {
    transform: translate3d(0, 0, 80px);
  }

  &:hover .cardContainer .logo .circle4 {
    transform: translate3d(0, 0, 100px);
  }

  &:hover .cardContainer .logo .circle5 {
      ...
      <div className="cardContainer">
        ...
        <div className="bottom">
          <div className="social-buttons-container">
            <button className="social-button social-button1" aria-label="Instagram">
            ...
            <button className="social-button social-button2" aria-label="Twitter">
            ...
            <button className="social-button social-button3" aria-label="Discord">
