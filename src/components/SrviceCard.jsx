  ...
  return (
    <CardContainer>
      <TopSection>
        ...
        <IconsContainer>
          <Logo>
            <SvgIcon fill="none" viewBox="0 0 94 94" size="40px">
              <path
                fill="white"
          ...
          <SocialMedia>
            <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
      ...
      <BottomSection>
        <Title>UNIVERSE OF UI</Title>
        <Row>
          <Item>
            <BigText>2626</BigText>
            <RegularText>UI elements</RegularText>
          </Item>
          <Item>
            <BigText>100%</BigText>
            <RegularText>Free for use</RegularText>
          </Item>
          <Item>
            <BigText>38,631</BigText>
            <RegularText>Contributers</RegularText>
          </Item>
        </Row>
      </BottomSection>
    </CardContainer>
